...
function template_admin_header($title, $selected = 'dashboard', $selected_child = '') {
    ...
    $admin_links = '
        ...
        <a href="assignments.php"' . ($selected == 'assignments' ? ' class="selected"' : '') . '><i class="fas fa-users"></i>Assignments</a>
        <div class="sub">
            <a href="assignments.php"' . ($selected == 'assignments' && $selected_child == 'view' ? ' class="selected"' : '') . '><span>&#9724;</span>View Assignments</a>
        </div>        
    ';
    ...
    <body class="admin">
        ...
        <main class="responsive-width-100">
            <header>
                ...
                <a href="about.php" class="right"><i class="fas fa-assignment-circle"></i></a>
