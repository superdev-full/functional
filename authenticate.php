...
if (!isset($_POST['username'], $_POST['password'])) {
	...
	exit('<center>Please fill both the username and password fields!</center>');
}
...
if ($stmt->num_rows > 0) {
	...
	if (password_verify($_POST['password'], $password)) {
		...
		if (account_activation && $activation_code != 'activated') {
			...
			echo '<center>Please activate your account to login! Click <a href="resendactivation.php">here</a> to resend the activation email.</center>';
		} else {
