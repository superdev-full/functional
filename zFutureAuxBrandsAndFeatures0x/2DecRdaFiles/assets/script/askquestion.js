$(document).ready(function () {
  $("#qtitle").val(getCookie("askquestion"));
  ...
  $(".next").click(function () {
    ...
    if( $('#qtitle').val().trim() == "" ){
      ...
      return false;
    }else if( $('#qtitle').val().trim().length > Q_TITLE_LIMIT ){
      alert('Your title is too long, maximum length allow is ' + Q_TITLE_LIMIT + ' characters.');
      return false;
    }else if( $('#description').val().trim().length > Q_DESCRIPTION_LIMIT ){
      alert('Your description is too long, maximum length allow is ' + Q_DESCRIPTION_LIMIT + ' characters.');
      return false;
    }

    // Update the cookie
    setCookie("askquestion", $('#qtitle').val(), 30);
