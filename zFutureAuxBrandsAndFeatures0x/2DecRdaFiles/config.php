<?php
/* RubberDuckyAnswers Environment */
define('rdaEnvironment'		, 'https://dev.rubberduckyanswers.com/');
define('BASE_PATH'			, '/home/build428/dev.rubberduckyanswers.com/');
//--------------
...
// Page payment.
define('PAYPAL_PAYMENT_PAGE_URL'	,rdaEnvironment . 'paypal/payment.php');
// Successfull payment.
define('PAYPAL_RETURN_URL'	,rdaEnvironment . 'paypal/success.php');
// Failed or Cancelled payment 
define('PAYPAL_CANCEL_URL'	,rdaEnvironment . 'paypal/cancel.php');
// PayPal IPN.
define('PAYPAL_NOTIFY_URL'	,rdaEnvironment . 'paypal/ipn.php');
// currency code.
...
// database username
define('db_user'			,'build428_devrubberduckyanswersadm');
// database password
define('db_pass'			,'dev538434906rdj0$#');
// database name
define('db_name'			,'build428_devrubberduckyanswers');
...
define('mail_from'			,'RubberDuckyAnswers <noreply@rubberduckyanswers.com>');
// Link to activation file
define('activation_link'	, rdaEnvironment . 'activate.php');
//--------------

/* Folders and Paths */
// Attachments upload folder
define('UPLOAD_PATH'		, BASE_PATH . 'uploads/');
define('UPLOAD_PATH_URL'	, rdaEnvironment . 'uploads/');
...
define('AVATARS_PATH_URL'	, rdaEnvironment . 'uploads/');
// Messages upload folder
define('MESSAGES_UPLOAD_PATH', UPLOAD_PATH . 'm/');
define('MESSAGES_PATH_URL'	 , rdaEnvironment . 'uploads/m/');
//--------------

/* Question's content Limits to fit in UI*/
define('Q_TITLE_LIMIT'		, 255);
define('Q_DESCRIPTION_LIMIT', 500);
//--------------
?>
