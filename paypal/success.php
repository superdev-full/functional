...
if(!empty($_GET['item_number']) && !empty($_GET['tx']) && !empty($_GET['amt']) && !empty($_GET['cc']) && !empty($_GET['st'])){
    ...
    // https://dev.justmaverit.com/paypal/success.php?item_number=40&tx=97798184WB6613906&amt=1&cc=USD&st=Completed
    // https://dev.justmaverit.com/paypal/success.php?item_number=42&tx=7KC47686930364711&amt=1&cc=USD&st=Completed
    // https://dev.justmaverit.com/paypal/success.php?item_number=43&tx=4SK458144J118531C&amt=1&cc=USD&st=Completed
